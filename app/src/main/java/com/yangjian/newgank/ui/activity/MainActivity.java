...
import com.yangjian.newgank.http.CallBack;
import com.yangjian.newgank.http.RequestManager;
import com.yangjian.newgank.theme.ColorRelativeLayout;
import com.yangjian.newgank.theme.ColorUiUtil;
import com.yangjian.newgank.theme.ColorView;
import com.yangjian.newgank.theme.Theme;
import com.yangjian.newgank.ui.fragment.AllFragment;
import com.yangjian.newgank.ui.fragment.CommonFragment;
import com.yangjian.newgank.ui.fragment.FuLiFragment;
import com.yangjian.newgank.utils.DimenUtils;
import com.yangjian.newgank.utils.PreUtils;
import com.yangjian.newgank.utils.SystemUtils;
import com.yangjian.newgank.utils.ThemeUtils;
import com.yangjian.newgank.widget.ResideLayout;
...
public class MainActivity extends BaseActivity implements ColorChooserDialog.ColorCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RequestManager.get(getName(), "http://gank.io/api/data/休息视频/1/1", true, new CallBack<List<Gank>>() {
            @Override
            public void onSuccess(List<Gank> result) {
                mDesc.setText(result.get(0).getDesc());
            }
        });

        RequestManager.get(getName(), "http://gank.io/api/data/福利/1/1", true, new CallBack<List<Gank>>() {
            @Override
            public void onSuccess(List<Gank> result) {
                Picasso.with(MainActivity.this)
