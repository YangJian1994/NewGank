...
import com.yangjian.newgank.app.NewGank;
import com.yangjian.newgank.db.DBManager;
import com.yangjian.newgank.utils.NetworkUtils;
...
public class RequestManager {
    ...
    public static void getList(Object tag, final String url, final Type type, final boolean isCache, final HttpListener listener) {
        ...
        if (!NetworkUtils.isConnectedByState(NewGank.getContext())) {
            listener.onFailure(5, "网络开小差了！！");
            return;
        }
        if (!NetworkUtils.isNetAvailable(NewGank.getContext())) {
        ...
        okHttpClient.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(final Call call, final Response response) throws IOException {
                ...
                if (authorization != null) {
                    PreUtils.putString(NewGank.getContext(), "Authorization", "Beare " + authorization);
                }
